  ...
  return (
    <KeyboardAwareScrollView style={styles.container}>
      <View style={styles.innerContainer}>
        ...
        <TextInput placeholder="Resource Link"  placeholderTextColor="gray" style={styles.textInput} 
        ...
        <TouchableOpacity style={styles.submitButtonContainer} onPress= {()=> handleCreateResource() }>
