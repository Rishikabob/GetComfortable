...
const MentorNotifScreen = () => {
            ...
            [
              {
                ...
                onPress: () => {
                  ...
                  const dbRef = ref(db, 'mentorNotifications/');
                  remove(dbRef);
                },
              },
              {
    ...
    const userNotifRef = ref(db,'mentorNotifications/')
...
export default MentorNotifScreen
