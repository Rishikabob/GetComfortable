...
import { getDatabase, ref, child, onValue, update, query, orderByChild, equalTo } from 'firebase/database';
import { Ionicons } from '@expo/vector-icons';
import { TextInput } from 'react-native';


const ReactivateUserScreen = () => {
  ...
  useEffect(() => {
    ...
    const orderedQuery = query(usersRef, orderByChild('inactive'), equalTo(true));
  ...
  const renderUser = ({ item: user }) => (
    <TouchableOpacity onPress={() => handleActivateUser(user.id)}>
