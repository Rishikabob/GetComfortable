...
const GlobalNotifScreen = () => {
            ...
            [
              {
                ...
                onPress: () => {
                  ...
                  const dbRef = ref(db, 'globalNotifications/');
                  remove(dbRef);
                },
              },
              {
    ...
    const globalNotifRef = ref(db,'globalNotifications/')
    //fetch and read data from database
    useEffect(() => {
      return onValue(globalNotifRef, (snapshot) => {
...
export default GlobalNotifScreen
